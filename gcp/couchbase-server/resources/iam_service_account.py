def GenerateConfig(context):
    ...
    accountName = 'cb-server-sa-{}'.format(suffix)
    resources = []
    outputs = []
    outputs.append({
        'name': 'serviceAccount',
    ...
    serviceAccount = {
        ...
        'properties': {
            ...
            'displayName': 'Couchbase Server Service Account'
        }
    }
    resources.append(serviceAccount)
    # add a key to the user
    accountKey = {
        'name': 'cb-server-sa-key-{}'.format(suffix),
    ...
    accessorBinding = {
        'name': 'cb-server-sa-secret-binding-{}'.format(suffix),
    ...
    editorBinding = {
        'name': 'cb-server-sa-editor-binding-{}'.format(suffix),
        'type': 'gcp-types/cloudresourcemanager-v1:virtual.projects.iamMemberBinding',
        'properties': {
            'role': 'roles/editor',
            'member': 'serviceAccount:{}@{}.iam.gserviceaccount.com'.format(accountName, project),
